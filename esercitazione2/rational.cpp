...
int main(void) {				//void significa che main non riceve nessun argomento quando viene chiamata
    using rat = rational<int>;	//Da ora in poi, quando scrivo rat, intendo 'frazione di numeri interi
								//rat è l'abbreviazione di numero intero
    
    rat r1(1,3);				//chiama la scatola rat r1 e poi ci mette dentro la frazione 1/3
    rat r2(1,6);
    ...
    rat r3 = r1+r2;
    std::cout << "The inverse of " << r3 << " is " << inv(r3) << "; ";		//l'inverso, cioè 1/3 diventa 3
    ...
    rat r5 = rat(3,4) + 2;		//sto facendo 3/4 + 2/1
